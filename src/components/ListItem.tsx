...
import {Box, Paper, Text, Group, Button, Checkbox, TextInput} from '@mantine/core';
    ...
    <Box className="flex flex-col gap-2">
      ...
      >
        <Group>
          ...
          {isEditing && <><TextInput value={value} onChange={(e) => setValue(e.target.value)} /><Button onClick={handleSave}>Save</Button></>}
        </Group>
        <Group>
          <Button color="gray.7" leftSection={isDesktop ? <FaPencil /> : false} onClick={handleEdit}>
